// club_data.jsx — sample content for 靈感俱樂部 (Riso Zine prototype)
...
const NAV = ['網頁最新發佈', '作品展演', '活動花絮'];
const VERBS = ['學習', '研究', '創造', '製造', '創作'];

window.CLUB = { CATEGORIES, POSTS, ARTWORKS, PHOTOS, MEMBERS, NAV, VERBS };
