// club_app.jsx — 靈感俱樂部 main app (Riso Zine prototype)
const { useState, useEffect, useRef, useMemo } = React;
const { CATEGORIES, POSTS, ARTWORKS, PHOTOS, MEMBERS, NAV, VERBS } = window.CLUB;
    ...
    <header className="mast">
      <div className="mast-top">
        <div className="hdr-brand">
          <image-slot id="club-logo" class="logo-slot" shape="rounded" radius="10" placeholder="放 Logo"></image-slot>
