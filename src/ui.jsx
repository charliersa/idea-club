// ui.jsx — shared building blocks: seeded duotone "riso" placeholders, icons,
// auto-scroll marquee, modal, small bits.
...
export const INK_VAR = { pink: 'var(--k-pink)', blue: 'var(--k-blue)', grape: 'var(--k-grape)' };

/* ---------- RisoImage : procedural duotone artwork placeholder ---------- */
export function RisoImage({ seed = 1, inks = ['pink', 'blue'], className = '', style = {} }) {
...
/* ---------- category line icons ---------- */
export function CatIcon({ id, size = 22 }) {
...
export function Marquee({ direction = 'vertical', durationSec = 40, gap = 14, className = '', children }) {
...
export function Overlay({ open, onClose, children, wide = false }) {
  useEffect(() => {
    if (!open) return;
